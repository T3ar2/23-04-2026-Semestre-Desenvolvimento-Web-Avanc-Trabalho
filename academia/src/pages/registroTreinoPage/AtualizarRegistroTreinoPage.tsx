...
import "../../css/AtualizarRegistroTreino.css";
      ...
      <div className="card">
        <div className="card-header">
          <div className="card-header-left">
            ...
            <span className="card-title"><strong>Atualizar</strong> execução de treino</span>
          </div>
          <span className="card-subtitle">Monitore a frequência e o desempenho dos alunos nos treinos agendados</span>
          <button type="button" className="btn-close" title="Fechar" onClick={() => navigate('/registro-treino')}>✕</button>
        </div>
